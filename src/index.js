...
export { analyzeFeed, analyzeFeedAsync } from './feed/analyzer.js';
export { CollectingEmbedder, runWarmed, buildSystemWith } from './embeddings/warm-run.js';
...
export { extractProductFromHtml, inferSearchQueries, scanProduct } from './predict/pdp.js';
